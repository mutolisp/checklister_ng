...
import { buildPlotYamlDoc, buildSessionYamlDoc } from '../src/lib/bundleYaml.ts';
...
// ── 1. Plot ───────────────────────────────────────────────────────────────
{
  ...
  eq('species[0].name', s0.name, 'Lithocarpus konishii');
...
// ── 2. Session ────────────────────────────────────────────────────────────
{
  ...
  eq('record.name', r0.name, 'Ficus caulocarpa');
